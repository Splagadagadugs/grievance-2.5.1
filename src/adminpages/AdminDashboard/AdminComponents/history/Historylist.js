...
import EditForm3 from './EditForm';
import AddForm3 from './AddForm';
...
export default function Historylist() {
  ...
  return (
    <>
      ...
      >
        <Box sx={style}>
          <AddForm3 closeEvent={handleClose} />
        </Box>
      </Modal> 
      ...
      >
        <Box sx={style}>
          <EditForm3 closeEvent={handleEditClose} fid={formid}/>
        </Box>
      </Modal>
    ...
    <Paper sx={{ width: '100%', overflow: 'hidden' }}>
      ...
      <Box height={10} />
          <Stack direction="row" spacing={2} className="my-2 mb-2">
            <Autocomplete
              ...
              getOptionLabel={(rows) => rows.firstName && rows.Email}
              renderInput={(params) => (
      ...
      <TableContainer sx={{ maxHeight: 400, maxWidth: 1200 }}>
                        ...
                        <TableCell align="left">
                          <Stack spacing={2} direction="row">
                            <EditIcon
                              ...
                              onClick={() => {
                                editData(row.id, row.firstName, row.lastName , row.middleName, row.Email, row.StudentNumber, row.ContactNumber,row.CurrentCollege, row.CurrentYear, row.ClassificationConcern,row.NatureConcern, row.Concern, row.Status);
                              }}
